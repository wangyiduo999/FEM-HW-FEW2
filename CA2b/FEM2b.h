...
double FEM<dim>::basis_function(unsigned int node, double xi_1, double xi_2, double xi_3) {
    ...
    //EDIT
    switch (node) {
    case 0:   //base function 1
        value = 0.125 * (1.0 - xi_1) * (1.0 - xi_2) * (1.0 - xi_3);
        break;

    case 1:   //base function 2
        value = 0.125 * (1.0 + xi_1) * (1.0 - xi_2) * (1.0 - xi_3);
        break;
    case 2:   //base function 4
        value = 0.125 * (1.0 - xi_1) * (1.0 + xi_2) * (1.0 - xi_3);
        break;
    case 3:   //base function 3
        value = 0.125 * (1.0 + xi_1) * (1.0 + xi_2) * (1.0 - xi_3);
        break;
    case 4:   //base function 1
        value = 0.125 * (1.0 - xi_1) * (1.0 - xi_2) * (1.0 + xi_3);
        break;
    case 5:   //base function 2
        value = 0.125 * (1.0 + xi_1) * (1.0 - xi_2) * (1.0 + xi_3);
        break;
    case 6:   //base function 4
        value = 0.125 * (1.0 - xi_1) * (1.0 + xi_2) * (1.0 + xi_3);
        break;
    case 7:   //base function 3
        value = 0.125 * (1.0 + xi_1) * (1.0 + xi_2) * (1.0 + xi_3);
        break;
    default:
        cout << "node number out of range: node number = " << node << endl;
    }
...
std::vector<double> FEM<dim>::basis_gradient(unsigned int node, double xi_1, double xi_2, double xi_3) {
    ...
    switch (node) {
    case 0:   //base function 1
        values[0] = 0.125 * (-1.0 + xi_2) * (1.0 - xi_3);
        values[1] = 0.125 * (-1.0 + xi_1) * (1.0 - xi_3);
        values[2] = 0.125 * (1 - xi_1) * (1.0 - xi_2) * (-1.0);
        break;

    case 1:   //base function 2
        values[0] = 0.125 * (1.0 - xi_2) * (1.0 - xi_3);
        values[1] = 0.125 * (-1.0 - xi_1) * (1.0 - xi_3);
        values[2] = 0.125 * (1.0 - xi_1) * (1.0 + xi_2) * (-1.0);
        break;
    case 2:   //base function 4
        values[0] = 0.125 * (-1.0 - xi_2) * (1.0 - xi_3);
        values[1] = 0.125 * (1.0 - xi_1) * (1.0 - xi_3);
